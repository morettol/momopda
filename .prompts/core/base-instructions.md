...
* Comments: All inline comments and block comments should end with proper punctuation (period, exclamation mark, or question mark). Single-line comments should be written as complete sentences. Example: `// Do this thing here.`
